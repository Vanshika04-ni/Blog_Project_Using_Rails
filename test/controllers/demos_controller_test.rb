...
class DemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demo" do
    assert_difference('Demo.count') do
      post demos_url, params: { demo: { description: @demo.description, title: @demo.title, user_name: @demo.user_name } }
    end
  ...
  test "should update demo" do
    patch demo_url(@demo), params: { demo: { description: @demo.description, title: @demo.title, user_name: @demo.user_name } }
